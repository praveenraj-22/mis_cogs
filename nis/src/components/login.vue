        ...
        <v-card class="elevation-12" tile hover>
          ...
          <v-card-text>
            <v-form ref="form" v-model="valid" lazy-validation>
              <v-text-field v-model="name" :rules="nameRules" label="Name" required @keydown.enter="submit"
                autofocus="autofocus"></v-text-field>
              <v-text-field v-model="password" :rules="passRules" label="Password" required @keydown.enter="submit"
              ...
              <v-spacer></v-spacer>
              <v-btn :disabled="!valid" color="grey darken-2" class="white--text" @click="submit" :loading="loading">
                Login</v-btn>
